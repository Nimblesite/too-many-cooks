...
void main() {
  ...
  test(
    'POST /mcp with stale session ID returns 404',
    () async {
      final headers = JSObject()
        ..['Content-Type'] = 'application/json'.toJS
        ..['Accept'] = _accept.toJS
        ..['mcp-session-id'] =
            'deadbeef-0000-0000-0000-000000000000'.toJS;
      ...
      final status =
          (response['status'] as JSNumber?)?.toDartInt ??
              0;
  ...
  test(
    'GET /mcp with stale session ID returns 404',
    () async {
      final headers = JSObject()
  ...
  test(
    'POST /admin/events with stale session ID returns 404',
    () async {
      final headers = JSObject()
        ..['Content-Type'] = 'application/json'.toJS
        ..['Accept'] = _accept.toJS
  ...
  test(
    'GET /admin/events with stale session ID returns 404',
    () async {
      final headers = JSObject()
        ..['Accept'] = 'text/event-stream'.toJS
        ..['mcp-session-id'] =
